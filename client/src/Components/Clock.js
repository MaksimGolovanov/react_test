...
const Clock = () => {
  ...
  return (
    <div className="text-center mr-4">
      <p style={{ fontWeight: 'bold', color: '#707070', fontSize: '43px', lineHeight: '1.0' }} className="m-0">{currentTime}</p>
      <p style={{ fontWeight: 'bold', color: '#707070', fontSize: '22px', lineHeight: '1.0' }}className="m-0">{currentDate}</p>
    </div>
  );
};
