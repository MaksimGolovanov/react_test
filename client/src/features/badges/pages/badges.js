...
function BadgePage() {
  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        ...
        setDolgnostList(Array.isArray(dolgnost) ? dolgnost : []);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  const getDepartmentById = (id) => {
    ...
    const foundDepartment =
      departments.find((d) => d.code === departmentCode) ||
      departments.find((d) => d.code === id);
                          ...
                          onChange={(e) => {
                            const updated = selectedBadges.map((b) =>
                              b.uid === badge.uid
                                ? {
                                    ...b,
                                    isSafetyOfficer: e.target.checked,
                                  }
                                : b
                            );
                      ...
                      <Col md={6}>
                        <div className={`${styles.badge} ${styles.textCenter}`}>
                          ...
                          >
                            ...
                            />
                            <div className={`${styles.badgeCompanyName} w-100`}>
                          ...
                          <div className={styles.badgeFooter}>
                            <div className="p-1">
                              <h6 className="m-0">{`${getDolgnostByCode(
                                badge.post
                              )}, ${getDepartmentById(badge.department)}`}</h6>
                              {badge.isSafetyOfficer && (
                                <div
