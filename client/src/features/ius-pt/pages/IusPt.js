          ...
          <tbody className={styles.bodyTable}>
            {sortedUsers.map((staffUser, index) => (
              <tr key={index}>
                <td style={{ width: '45px' }}>
                  <Circle
                    fullName={staffUser.fio}
                    employeeId={staffUser.tabNumber}
                    size={30}
                  />
                </td>
                <td
