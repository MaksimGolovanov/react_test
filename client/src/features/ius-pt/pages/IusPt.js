...
import SearchBar from '../components/SearchBar/SearchBar'; // Импорт компонента SearchBar
import UserTable from '../components/UserTable/TableUser';  // Импорт компонента UserTable
