...
export class IusPtStore {
  ...
  get signatures() {
    return this.signatureStore.signatures;
  }
  get signature() {
    return this.signatureStore.signatures;
  ...
  get stopRoles() {
    return this.roleStore.stopRoles;
  }
  get rolesTypes() {
    return this.roleStore.rolesTypes;
  }

  // Пользователи
  get iusUsers() {
    return this.userStore.iusUsers;
  }
  get userRoles() {
  ...
  // Сотрудники
  get staffWithIusUsers() {
    return this.staffStore.staffWithIusUsers;
  }
  get staffWithIusUsersSimple() {
    return this.staffStore.staffWithIusUsersSimple;
  }
  get staffWithIusUsersSimpleOver() {
    return this.staffStore.staffWithIusUsersSimpleOver;
  }
  ...
  createSignature = (signature) =>
    this.signatureStore.createSignature(signature);
  updateSignature = (signature) =>
    this.signatureStore.updateSignature(signature);
  ...
  updateStopRole = (id, stopRoleData) =>
    this.roleStore.updateStopRole(id, stopRoleData);
  deleteStopRole = (id) => this.roleStore.deleteStopRole(id);
  createStopRole = (stopRoleData) =>
    this.roleStore.createStopRole(stopRoleData);
  ...
  deleteUserRole = (tabNumber, roleId) =>
    this.userStore.deleteUserRole(tabNumber, roleId);
  addRolesToUser = (tabNumber, roleIds) =>
    this.userStore.addRolesToUser(tabNumber, roleIds);

  // ========== МЕТОДЫ ДЛЯ СОТРУДНИКОВ ==========

  fetchStaffWithUsers = () => this.staffStore.fetchWithUsers();
  fetchStaffWithIusUsers = () => this.staffStore.fetchStaffWithIusUsers();
  fetchStaffByTabNumber = (tabNumber) =>
    this.staffStore.fetchStaffByTabNumber(tabNumber);
  fetchStaffWithIusUserSimple = () =>
    this.staffStore.fetchStaffWithIusUserSimple();
  fetchStaffWithIusUserSimpleOver = () =>
    this.staffStore.fetchStaffWithIusUserSimpleOver();
}
