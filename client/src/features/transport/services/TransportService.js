...
class TransportService {
    ...
    static async fetchVehicleById(id) {
        try {
            const response = await axios.get(`${API_URL}api/transport/vehicles/${id}`)
            return response.data
        } catch (error) {
    ...
    static async createVehicle(vehicleData) {
        try {
            const response = await axios.post(`${API_URL}api/transport/vehicles`, vehicleData, {
    ...
    static async updateVehicle(id, updatedData) {
        try {
            const response = await axios.put(`${API_URL}api/transport/vehicles/${id}`, updatedData, {
                headers: { 'Content-Type': 'application/json' },
            })
            return response.data
        } catch (error) {
    ...
    static async importVehicles(vehiclesData) {
        try {
            const response = await axios.post(`${API_URL}api/transport/vehicles/import`, vehiclesData)
            return response.data
        } catch (error) {
    ...
    static async fetchBookingsByDate(date) {
        try {
            const response = await axios.get(`${API_URL}api/transport/bookings/date/${date}`)
            return response.data
        } catch (error) {
    ...
    static async fetchBookingsByVehicle(vehicleId, date) {
        try {
            const response = await axios.get(`${API_URL}api/transport/bookings/vehicle/${vehicleId}`, {
                params: { date }
            })
            return response.data
        } catch (error) {
    ...
    static async createBooking(bookingData) {
        try {
            const response = await axios.post(`${API_URL}api/transport/bookings`, bookingData, {
                headers: { 'Content-Type': 'application/json' },
            })
            return response.data
        } catch (error) {
    ...
    static async cancelBooking(bookingId, cancelledBy) {
        try {
            const response = await axios.put(`${API_URL}api/transport/bookings/${bookingId}/cancel`, 
    ...
    static async createDepartment(departmentData) {
        try {
            const response = await axios.post(`${API_URL}api/transport/departments`, departmentData, {
                headers: { 'Content-Type': 'application/json' },
            })
            return response.data
        } catch (error) {
    ...
    static async updateDepartment(id, updatedData) {
        try {
            const response = await axios.put(`${API_URL}api/transport/departments/${id}`, updatedData, {
                headers: { 'Content-Type': 'application/json' },
            })
            return response.data
        } catch (error) {
    ...
    static async createVehicleType(typeData) {
        try {
            const response = await axios.post(`${API_URL}api/transport/vehicle-types`, typeData, {
                headers: { 'Content-Type': 'application/json' },
            })
            return response.data
        } catch (error) {
            console.error('Create vehicle type error:', error.response?.data || error.message)
            throw error
        }
    }
    ...
    static async updateVehicleType(id, updatedData) {
        try {
            const response = await axios.put(`${API_URL}api/transport/vehicle-types/${id}`, updatedData, {
                headers: { 'Content-Type': 'application/json' },
            })
            return response.data
        } catch (error) {
            console.error('Update vehicle type error:', error.response?.data || error.message)
            throw error
        }
    }
    ...
    static async fetchVehicleSubtypes() {
        try {
            const response = await axios.get(`${API_URL}api/transport/vehicle-subtypes`)
            return response.data
        } catch (error) {
    ...
    static async createVehicleSubtype(subtypeData) {
        try {
            const response = await axios.post(`${API_URL}api/transport/vehicle-subtypes`, subtypeData, {
                headers: { 'Content-Type': 'application/json' },
            })
            return response.data
        } catch (error) {
            console.error('Create vehicle subtype error:', error.response?.data || error.message)
            throw error
        }
    }
    ...
    static async updateVehicleSubtype(id, updatedData) {
        try {
            const response = await axios.put(`${API_URL}api/transport/vehicle-subtypes/${id}`, updatedData, {
                headers: { 'Content-Type': 'application/json' },
            })
            return response.data
        } catch (error) {
            console.error('Update vehicle subtype error:', error.response?.data || error.message)
            throw error
        }
    }
    ...
    static async fetchStatisticsByDate(date) {
        try {
            const response = await axios.get(`${API_URL}api/transport/statistics/date/${date}`)
            return response.data
        } catch (error) {
