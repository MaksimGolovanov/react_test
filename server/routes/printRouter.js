...
router.post('/statistics', printController.createStatistic) // новый
router.put('/statistics/:id', printController.updateStatistic) // новый
router.delete('/statistics/:id', printController.deleteStatistic) // новый
